...
Route::post('/send_otp',[PageController::class,'sendOTP'])->name('send_otp');
Route::get('/reset_otp',[PageController::class,'res_otp'])->name('reset_otp');
Route::get('/reset_pass',[PageController::class,'res_pass'])->name('reset_pass');
Route::post('/reset',[PageController::class,'matchOTP'])->name('matchOTP');
Route::post('/rs',[PageController::class,'changePass'])->name('changePass');
Route::get('/conf',[PageController::class,'change_confirm'])->name('change_confirm');
...
//Doctor Pages
Route::get('/doctor/register',[DoctorController::class,'index'])->name('register');
Route::post('/doctor/register',[DoctorController::class,'create'])->name('registerSubmitted');
Route::get('/doctor/dashboard',[DoctorController::class,'dashboard'])->name('doc_dashboard')->middleware('ValidDoctor');
Route::get('/doctor/profile',[DoctorController::class,'loadProfile'])->name('profile')->middleware('ValidDoctor');
Route::post('/doctor/profile',[DoctorController::class,'updateProfile'])->name('profileUpdate')->middleware('ValidDoctor');
Route::get('/doctor/payment',[RemunerationController::class,'index'])->name('pay_setup')->middleware('ValidDoctor');
Route::post('/doctor/payment',[RemunerationController::class,'create'])->name('setup_pay')->middleware('ValidDoctor');
Route::post('/doctor/payment/edit',[RemunerationController::class,'update_rm'])->name('edit_pay')->middleware('ValidDoctor');
Route::get('/doctor/inbox',[InboxController::class,'index'])->name('inbox')->middleware('ValidDoctor');
Route::get('/doctor/inbox/{i_id}',[ConversationController::class,'index'])->name('goConversation')->middleware('ValidDoctor');
Route::get('/doctor/conversation/reply/{c_id}',[ConversationController::class,'replyMessage'])->name('goReply')->middleware('ValidDoctor');
Route::post('/doctor/message/reply',[ConversationController::class,'reply'])->name('reply_msg')->middleware('ValidDoctor');
Route::get('/doctor/message/new/{i_id}',[ConversationController::class,'createMessage'])->name('goConv')->middleware('ValidDoctor');
Route::post('/doctor/message/send',[ConversationController::class,'create'])->name('sender')->middleware('ValidDoctor');
Route::get('/doctor/appointment/finish/{i_id}',[InboxController::class,'finish'])->name('finish')->middleware('ValidDoctor');
Route::get('/doctor/earning',[PatientPaymentController::class,'index'])->name('earning')->middleware('ValidDoctor');
Route::get('/doctor/appointments',[AppointmentController::class,'store'])->name('appointments')->middleware('ValidDoctor');
Route::get('/doctor/appointments/search',[AppointmentController::class,'index'])->name('search_a')->middleware('ValidDoctor');
Route::get('/doctor/medical_history',[MedicalHistoryController::class,'index'])->name('history')->middleware('ValidDoctor');
Route::get('/doctor/patient/issues/{h_id}',[IssueController::class,'index'])->name('issue')->middleware('ValidDoctor');
Route::get('/doctor/review',[ReviewController::class,'index'])->name('review')->middleware('ValidDoctor');
Route::post('/doctor/review',[ReviewController::class,'create'])->name('reviews')->middleware('ValidDoctor');
Route::get('/doctor/review/old',[ReviewController::class,'old_fed'])->name('old_review')->middleware('ValidDoctor');
Route::get('/doctor/review/delete/{r_id}',[ReviewController::class,'delete'])->name('removeReview')->middleware('ValidDoctor');
Route::get('/doctor/appointment/excel',[AppointmentController::class,'create'])->name('cr')->middleware('ValidDoctor');
Route::get('/doctor/earning/report',[DoctorController::class,'dpdf'])->name('ar')->middleware('ValidDoctor');
Route::get('/doctor/prescription/{id}',[DoctorController::class,'pres'])->name('pr')->middleware('ValidDoctor');
Route::post('/doctor/prescription/send',[DoctorController::class,'sendMail'])->name('send')->middleware('ValidDoctor');
Route::get('/doctor/notices',[NoticeController::class,'doctorNotices'])->name('doc_notice')->middleware('ValidDoctor');
Route::get('/doctor/report_activity',[ReportController::class,'index'])->name('rep_ac')->middleware('ValidDoctor');
Route::post('/doctor/report_activity',[ReportController::class,'create'])->name('rep')->middleware('ValidDoctor');
Route::get('/doctor/reports/old',[ReportController::class,'show'])->name('prev_rep')->middleware('ValidDoctor');
Route::get('/doctor/report/delete/{r_id}',[ReportController::class,'destroy'])->name('delete_rep')->middleware('ValidDoctor');

//Seller Pages
Route::get('/seller/dashboard',[SellerController::class,'dashboard'])->name('s_dashboard')->middleware('ValidSeller');
Route::get('/seller/profile',[SellerController::class,'loadProfile'])->name('s_profile')->middleware('ValidSeller');
Route::post('/seller/profile',[SellerController::class,'updateProfile'])->name('s_profileUpdate')->middleware('ValidSeller');
Route::get('/seller/add_medicine',[MedicineController::class,'add'])->name('add_medicine')->middleware('ValidSeller');
Route::post('/seller/add_medicine',[MedicineController::class,'create'])->name('add_med')->middleware('ValidSeller');
Route::get('/seller/manage_meds',[MedicineController::class,'index'])->name('manage_med')->middleware('ValidSeller');
Route::get('/seller/med/show/{m_id}',[MedicineController::class,'showMed'])->middleware('ValidSeller');
Route::post('/seller/med/update',[MedicineController::class,'updateMed'])->name('update_med')->middleware('ValidSeller');
Route::get('/seller/med/delete/{m_id}',[MedicineController::class,'deleteMed'])->middleware('ValidSeller');
Route::get('/seller/med/search',[MedicineController::class,'store'])->name('search')->middleware('ValidSeller');
Route::get('/seller/orders',[OrderController::class,'index'])->name('orders')->middleware('ValidSeller');
Route::get('/seller/order/show/{o_id}',[OrderController::class,'showOrder'])->middleware('ValidSeller');
Route::post('/seller/order/update',[OrderController::class,'updateOrder'])->name('order')->middleware('ValidSeller');
Route::get('/seller/order',[OrderController::class,'create'])->name('or')->middleware('ValidSeller');
Route::get('/seller/earnings',[OrderController::class,'earn'])->name('earn')->middleware('ValidSeller');
Route::get('/seller/order/details/{o_id}',[OrderDetailController::class,'index'])->middleware('ValidSeller');
Route::get('/seller/report',[OrderController::class,'show'])->name('report')->middleware('ValidSeller');
Route::get('/seller/notices',[NoticeController::class,'sellerNotices'])->name('s_notice')->middleware('ValidSeller');
