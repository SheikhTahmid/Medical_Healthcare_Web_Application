...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="row">
        ...
        <td>{{ $p->quantity }}</td>
        <td><a href="/mC-{{ $p->medicine_id }}" class="btn btn-warning btn-sm"><i class='bx bxs-edit-alt' ></i></a> </td>
        <td><a href="/aR-{{ $p->medicine_id }}" class="btn btn-danger btn-sm"><i class='bx bx-block' ></i></a> </td>
                  </tr>
                  @endforeach
                </tbody>
              </table> <br>
